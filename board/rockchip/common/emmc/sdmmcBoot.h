...
extern uint32 SdmmcBootErase(uint8 ChipSel, uint32 blkIndex, uint32 nblk,
			      uint8 mod);
extern uint32 SdmmcBootReadPBA(uint8 ChipSel, uint32 PBA, void *pbuf,
				uint16 nSec);
extern uint32 SdmmcBootWritePBA(uint8 ChipSel, uint32 PBA, void *pbuf,
				 uint16 nSec);
extern void SdmmcCheckIdBlock(void);
extern uint32 SdmmcBootReadLBA(uint8 ChipSel, uint32 LBA, void *pbuf,
				uint16 nSec);
extern uint32 SdmmcBootWriteLBA(uint8 ChipSel, uint32 LBA, void *pbuf,
...
extern uint32 EmmcSetBootPart(uint32 ChipSel, uint32 BootPart,
			       uint32 AccessPart);
