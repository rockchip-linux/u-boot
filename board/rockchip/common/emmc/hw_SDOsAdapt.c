...
static void _AddToList(uint8 * pStr) 
{
		    ...
		    (SCREEN_PRINTF_LIST_T *)
		    SDOAM_Malloc(sizeof(SCREEN_PRINTF_LIST_T));
		Assert((gpScreenPrintfHead != NULL),
			"ERROR:_AddToList mallco failed\n", 0);
	    ...
	    (SCREEN_PRINTF_LIST_T *) SDOAM_Malloc(sizeof(SCREEN_PRINTF_LIST_T));
...
#else	/*  */
	    if (((ROCK_SEM_DATA *) handle != &gSD0_Sem)
		&& ((ROCK_SEM_DATA *) handle != &gSD1_Sem))
