...
 uint32 SdmmcBootReadLBA(uint8 ChipSel, uint32 LBA, void *pbuf, uint16 nSec)
{
	    ...
	    SDM_Read(ChipSel, LBA + gSdCardInfoTbl[ChipSel].FwPartOffset, nSec,
		     pbuf);
...
 uint32 SdmmcBootWriteLBA(uint8 ChipSel, uint32 LBA, void *pbuf, uint16 nSec,
			    uint16 mode)
{
	    ...
	    SDM_Write(ChipSel, LBA + gSdCardInfoTbl[ChipSel].FwPartOffset, nSec,
		      pbuf);
