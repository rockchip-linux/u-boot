...
/*
 * Float operation will cause the compile error.
 * Alread define ‘-mgeneral-regs-only’ in arch/arm/config.mk.
...
static int do_stressapptest(struct cmd_tbl *cmdtp, int flag, int argc, char *const argv[])
{
