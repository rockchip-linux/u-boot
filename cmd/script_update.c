...
static int do_script(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
...
static int do_sd_update(struct cmd_tbl *cmdtp, int flag,
...
static int do_usb_update(struct cmd_tbl *cmdtp, int flag,
			 int argc, char * const argv[])
{
	struct blk_desc *desc;
	struct udevice *dev;
...
static int do_tftp_update(struct cmd_tbl *cmdtp, int flag,
			  int argc, char * const argv[])
{
	char cmd[128];
	char *buf;
