...
int do_avb_ab_mark_slot_active(struct cmd_tbl *cmdtp, int flag,
			       int argc, char * const argv[])
{
	AvbOps *ops;
...
int do_avb_ab_mark_slot_unbootable(struct cmd_tbl *cmdtp, int flag,
				   int argc, char * const argv[])
{
	AvbOps *ops;
	unsigned int slot_number;
...
int do_avb_ab_mark_slot_successful(struct cmd_tbl *cmdtp, int flag,
				   int argc, char * const argv[])
{
	AvbOps *ops;
	unsigned int slot_number;
...
int do_avb_read_ab_metadata(struct cmd_tbl *cmdtp, int flag,
			    int argc, char * const argv[])
{
	AvbOps *ops;
	AvbABData ab_data;
...
int do_avb_write_ab_metadata(struct cmd_tbl *cmdtp, int flag,
			     int argc, char * const argv[])
{
	AvbOps *ops;
	AvbABData ab_data;
...
int do_avb_version(struct cmd_tbl *cmdtp, int flag, int argc,
		   char * const argv[])
{
...
int do_avb_read_rollback_index(struct cmd_tbl *cmdtp, int flag,
			       int argc, char * const argv[])
{
	AvbOps *ops;
...
int do_avb_write_rollback_index(struct cmd_tbl *cmdtp, int flag,
				int argc, char * const argv[])
{
	AvbOps *ops;
	uint64_t out_rollback_index;
...
int do_avb_read_is_device_unlocked(struct cmd_tbl *cmdtp, int flag,
				   int argc, char * const argv[])
{
	AvbOps *ops;
...
int do_avb_write_is_device_unlocked(struct cmd_tbl *cmdtp, int flag,
				    int argc, char * const argv[])
{
	AvbOps *ops;
	bool out_is_unlocked;
...
int do_avb_get_size_of_partition(struct cmd_tbl *cmdtp, int flag,
				 int argc, char * const argv[])
{
	AvbOps *ops;
...
int do_avb_get_get_unique_guid_for_partition(struct cmd_tbl *cmdtp, int flag,
					     int argc, char * const argv[])
{
	AvbOps *ops;
	char *requested_partitions;
...
int do_avb_read(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
	AvbOps *ops;
	char *requested_partitions;
	int64_t offset_blk;
...
int do_perm_attr_test(struct cmd_tbl *cmdtp, int flag,
		      int argc, char * const argv[])
{
	AvbOps *ops;
	int i;
...
int do_avb_verify_partition(struct cmd_tbl *cmdtp, int flag,
			    int argc, char * const argv[])
{
	AvbOps *ops;
...
static int do_boot_avb(struct cmd_tbl *cmdtp,
		       int flag,
		       int argc,
		       char * const argv[])
{
