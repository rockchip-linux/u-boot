...
--help|-help|help|--h|-h|debug|'')
	...
	echo "    9. riscv start.S: print entry warning"
	echo "   10. enable CONFIG_ROCKCHIP_CRASH_DUMP"
...
8)
	...
	;;
9)
	sed -i '/mv\ts1, a1/{n;s/^$/#ifndef CONFIG_SPL_BUILD\n\tli\tt0, CONFIG_DEBUG_UART_BASE\n\tli\tt1, 100\n1:\n\tli\tt2, 0x55\n\tSREG\tt2, 0(t0)\n\taddi\tt1, t1, -1\n\tbnez\tt1, 1b\n\tfence\tiorw, iorw\n#endif/;}' \
	./arch/riscv/cpu/start.S
	echo "DEBUG [9]: riscv start.S entry warning 'UUUU...'"
	;;
10)
	sed -i 's/\# CONFIG_ROCKCHIP_CRASH_DUMP is not set/CONFIG_ROCKCHIP_CRASH_DUMP=y/g' .config
	echo "DEBUG [10]: CONFIG_ROCKCHIP_CRASH_DUMP is enabled"
	;;
11)
