...
static int do_test_regulator(struct cmd_tbl *cmdtp, int flag,
...
static int do_test_reset(struct cmd_tbl *cmdtp, int flag,
			 int argc, char *const argv[])
{
...
static int do_test_dvfs(struct cmd_tbl *cmdtp, int flag,
			int argc, char *const argv[])
{
...
static int do_test_wdt(struct cmd_tbl *cmdtp, int flag,
		       int argc, char *const argv[])
{
	struct udevice *dev;
	int ret;
...
static int do_test_thermal(struct cmd_tbl *cmdtp, int flag,
			   int argc, char *const argv[])
{
	struct udevice *dev;
	int ret, temp;
...
static int do_test_pmic(struct cmd_tbl *cmdtp, int flag,
			int argc, char *const argv[])
{
	struct udevice *dev;
	struct uclass *uc;
...
static int do_test_charge(struct cmd_tbl *cmdtp, int flag,
			  int argc, char *const argv[])
{
	/* TODO */
	return 0;
