...
#ifdef CONFIG_CMD_GO
static int do_test_brom(struct cmd_tbl *cmdtp, int flag,
...
static int do_test_fastboot(struct cmd_tbl *cmdtp, int flag,
			    int argc, char *const argv[])
{
...
static int do_test_rockusb(struct cmd_tbl *cmdtp, int flag,
			   int argc, char *const argv[])
{
...
static int do_test_tftp(struct cmd_tbl *cmdtp, int flag,
			int argc, char *const argv[])
{
	char load_cmd[64];
