...
static int do_test_storage(struct cmd_tbl *cmdtp, int flag,
...
#ifdef CONFIG_MMC
static int do_test_emmc(struct cmd_tbl *cmdtp, int flag,
			int argc, char *const argv[])
{
	return do_test_storage(cmdtp, flag, argc, argv, "mmc", "0", "MMC0");
}

static int do_test_sdmmc(struct cmd_tbl *cmdtp, int flag,
			 int argc, char *const argv[])
{
...
#if defined(CONFIG_RKNAND) || defined(CONFIG_RKNANDC_NAND)
static int do_test_rknand(struct cmd_tbl *cmdtp, int flag,
			  int argc, char *const argv[])
{
...
#ifdef CONFIG_RKSFC_NAND
static int do_test_rkflash_spinand(struct cmd_tbl *cmdtp, int flag,
				   int argc, char *const argv[])
{
...
#ifdef CONFIG_RKSFC_NOR
static int do_test_rkflash_spinor(struct cmd_tbl *cmdtp, int flag,
				  int argc, char *const argv[])
{
...
#ifdef CONFIG_DM_RAMDISK
static int do_test_blk(struct cmd_tbl *cmdtp, int flag,
		       int argc, char *const argv[])
{
...
#ifdef CONFIG_SCSI
static int do_test_scsi(struct cmd_tbl *cmdtp, int flag,
			int argc, char *const argv[])
{
...
#if defined(CONFIG_OPTEE) && defined(CONFIG_MMC)
static int do_test_secure_storage(struct cmd_tbl *cmdtp, int flag,
				  int argc, char *const argv[])
{
...
static int do_test_env(struct cmd_tbl *cmdtp, int flag,
		       int argc, char *const argv[])
{
	int ret;
...
#ifdef CONFIG_ROCKCHIP_VENDOR_PARTITION
static int do_test_vendor(struct cmd_tbl *cmdtp, int flag,
			  int argc, char *const argv[])
{
...
static int do_test_efuse(struct cmd_tbl *cmdtp, int flag,
			 int argc, char *const argv[])
{
	struct udevice *dev;
	u8 fuses[128] = {0};
...
static int do_test_otp(struct cmd_tbl *cmdtp, int flag,
		       int argc, char *const argv[])
{
	struct udevice *dev;
	u8 otps[64] = {0};
...
static int do_test_part(struct cmd_tbl *cmdtp, int flag,
			int argc, char *const argv[])
{
...
static int do_test_usb(struct cmd_tbl *cmdtp, int flag,
		       int argc, char *const argv[])
{
