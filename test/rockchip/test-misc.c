...
int do_test_timer(struct cmd_tbl *cmdtp, int flag, int argc, char *const argv[])
{
	timer_delay_test();
...
int do_test_ir(struct cmd_tbl *cmdtp, int flag, int argc, char *const argv[])
{
	return ir_test();
}
#endif
...
#ifdef CONFIG_DM_KEY
int do_test_key(struct cmd_tbl *cmdtp, int flag, int argc, char *const argv[])
{
...
static int do_test_crypto(struct cmd_tbl *cmdtp, int flag,
...
#ifdef CONFIG_ADC
static int do_test_adc(struct cmd_tbl *cmdtp, int flag,
		       int argc, char *const argv[])
{
	uint val, chn;
	int ret;
