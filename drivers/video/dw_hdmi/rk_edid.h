...
struct hdmi_video_timing {
	struct video_mode mode;	// Video timing
...
extern void rk_hdmi_register(struct hdmi_dev *);
extern const struct video_mode* hdmi_edid_get_timing(struct hdmi_dev *hdmi_dev);
extern const struct hdmi_video_timing* dw_hdmi_vic2timing(struct hdmi_dev *hdmi_dev, int vic);
