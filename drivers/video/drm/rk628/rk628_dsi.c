...
#define RK628_MIPI_DSI_MSG_REQ_ACK	BIT(0)
/* use Low Power Mode to transmit message */
#define RK628_MIPI_DSI_MSG_USE_LPM	BIT(1)

enum rk628_dsi_vid_mode_type {
	RK628_DSI_VIDEO_MODE,
	RK628_DSI_COMMAND_MODE,
};
...
enum {
	RK628_MIPI_DSI_V_SYNC_START				= 0x01,
	RK628_MIPI_DSI_V_SYNC_END				= 0x11,
	RK628_MIPI_DSI_H_SYNC_START				= 0x21,
	RK628_MIPI_DSI_H_SYNC_END				= 0x31,

	RK628_MIPI_DSI_COLOR_MODE_OFF				= 0x02,
	RK628_MIPI_DSI_COLOR_MODE_ON				= 0x12,
	RK628_MIPI_DSI_SHUTDOWN_PERIPHERAL			= 0x22,
	RK628_MIPI_DSI_TURN_ON_PERIPHERAL			= 0x32,

	RK628_MIPI_DSI_GENERIC_SHORT_WRITE_0_PARAM		= 0x03,
	RK628_MIPI_DSI_GENERIC_SHORT_WRITE_1_PARAM		= 0x13,
	RK628_MIPI_DSI_GENERIC_SHORT_WRITE_2_PARAM		= 0x23,

	RK628_MIPI_DSI_GENERIC_READ_REQUEST_0_PARAM		= 0x04,
	RK628_MIPI_DSI_GENERIC_READ_REQUEST_1_PARAM		= 0x14,
	RK628_MIPI_DSI_GENERIC_READ_REQUEST_2_PARAM		= 0x24,

	RK628_MIPI_DSI_DCS_SHORT_WRITE				= 0x05,
	RK628_MIPI_DSI_DCS_SHORT_WRITE_PARAM			= 0x15,

	RK628_MIPI_DSI_DCS_READ					= 0x06,

	RK628_MIPI_DSI_DCS_COMPRESSION_MODE			= 0x07,
	RK628_MIPI_DSI_PPS_LONG_WRITE				= 0x0A,

	RK628_MIPI_DSI_SET_MAXIMUM_RETURN_PACKET_SIZE		= 0x37,

	RK628_MIPI_DSI_END_OF_TRANSMISSION			= 0x08,

	RK628_MIPI_DSI_NULL_PACKET				= 0x09,
	RK628_MIPI_DSI_BLANKING_PACKET				= 0x19,
	RK628_MIPI_DSI_GENERIC_LONG_WRITE			= 0x29,
	RK628_MIPI_DSI_DCS_LONG_WRITE				= 0x39,

	RK628_MIPI_DSI_LOOSELY_PACKED_PIXEL_STREAM_YCBCR20	= 0x0c,
	RK628_MIPI_DSI_PACKED_PIXEL_STREAM_YCBCR24		= 0x1c,
	RK628_MIPI_DSI_PACKED_PIXEL_STREAM_YCBCR16		= 0x2c,

	RK628_MIPI_DSI_PACKED_PIXEL_STREAM_30			= 0x0d,
	RK628_MIPI_DSI_PACKED_PIXEL_STREAM_36			= 0x1d,
	RK628_MIPI_DSI_PACKED_PIXEL_STREAM_YCBCR12		= 0x3d,

	RK628_MIPI_DSI_PACKED_PIXEL_STREAM_16			= 0x0e,
	RK628_MIPI_DSI_PACKED_PIXEL_STREAM_18			= 0x1e,
	RK628_MIPI_DSI_PIXEL_STREAM_3BYTE_18			= 0x2e,
	RK628_MIPI_DSI_PACKED_PIXEL_STREAM_24			= 0x3e,
};

/* MIPI DSI Peripheral-to-Processor transaction types */
enum {
	RK628_MIPI_DSI_RX_ACKNOWLEDGE_AND_ERROR_REPORT	= 0x02,
	RK628_MIPI_DSI_RX_END_OF_TRANSMISSION			= 0x08,
	RK628_MIPI_DSI_RX_GENERIC_SHORT_READ_RESPONSE_1BYTE	= 0x11,
	RK628_MIPI_DSI_RX_GENERIC_SHORT_READ_RESPONSE_2BYTE	= 0x12,
	RK628_MIPI_DSI_RX_GENERIC_LONG_READ_RESPONSE		= 0x1a,
	RK628_MIPI_DSI_RX_DCS_LONG_READ_RESPONSE		= 0x1c,
	RK628_MIPI_DSI_RX_DCS_SHORT_READ_RESPONSE_1BYTE	= 0x21,
	RK628_MIPI_DSI_RX_DCS_SHORT_READ_RESPONSE_2BYTE	= 0x22,
};

/* MIPI DCS commands */
enum {
	RK628_MIPI_DCS_NOP			= 0x00,
	RK628_MIPI_DCS_SOFT_RESET		= 0x01,
	RK628_MIPI_DCS_GET_DISPLAY_ID		= 0x04,
	RK628_MIPI_DCS_GET_RED_CHANNEL	= 0x06,
	RK628_MIPI_DCS_GET_GREEN_CHANNEL	= 0x07,
	RK628_MIPI_DCS_GET_BLUE_CHANNEL	= 0x08,
	RK628_MIPI_DCS_GET_DISPLAY_STATUS	= 0x09,
	RK628_MIPI_DCS_GET_POWER_MODE		= 0x0A,
	RK628_MIPI_DCS_GET_ADDRESS_MODE	= 0x0B,
	RK628_MIPI_DCS_GET_PIXEL_FORMAT	= 0x0C,
	RK628_MIPI_DCS_GET_DISPLAY_MODE	= 0x0D,
	RK628_MIPI_DCS_GET_SIGNAL_MODE	= 0x0E,
	RK628_MIPI_DCS_GET_DIAGNOSTIC_RESULT	= 0x0F,
	RK628_MIPI_DCS_ENTER_SLEEP_MODE	= 0x10,
	RK628_MIPI_DCS_EXIT_SLEEP_MODE	= 0x11,
	RK628_MIPI_DCS_ENTER_PARTIAL_MODE	= 0x12,
	RK628_MIPI_DCS_ENTER_NORMAL_MODE	= 0x13,
	RK628_MIPI_DCS_EXIT_INVERT_MODE	= 0x20,
	RK628_MIPI_DCS_ENTER_INVERT_MODE	= 0x21,
	RK628_MIPI_DCS_SET_GAMMA_CURVE	= 0x26,
	RK628_MIPI_DCS_SET_DISPLAY_OFF	= 0x28,
	RK628_MIPI_DCS_SET_DISPLAY_ON		= 0x29,
	RK628_MIPI_DCS_SET_COLUMN_ADDRESS	= 0x2A,
	RK628_MIPI_DCS_SET_PAGE_ADDRESS	= 0x2B,
	RK628_MIPI_DCS_WRITE_MEMORY_START	= 0x2C,
	RK628_MIPI_DCS_WRITE_LUT		= 0x2D,
	RK628_MIPI_DCS_READ_MEMORY_START	= 0x2E,
	RK628_MIPI_DCS_SET_PARTIAL_AREA	= 0x30,
	RK628_MIPI_DCS_SET_SCROLL_AREA	= 0x33,
	RK628_MIPI_DCS_SET_TEAR_OFF		= 0x34,
	RK628_MIPI_DCS_SET_TEAR_ON		= 0x35,
	RK628_MIPI_DCS_SET_ADDRESS_MODE	= 0x36,
	RK628_MIPI_DCS_SET_SCROLL_START	= 0x37,
	RK628_MIPI_DCS_EXIT_IDLE_MODE		= 0x38,
	RK628_MIPI_DCS_ENTER_IDLE_MODE	= 0x39,
	RK628_MIPI_DCS_SET_PIXEL_FORMAT	= 0x3A,
	RK628_MIPI_DCS_WRITE_MEMORY_CONTINUE	= 0x3C,
	RK628_MIPI_DCS_READ_MEMORY_CONTINUE	= 0x3E,
	RK628_MIPI_DCS_SET_TEAR_SCANLINE	= 0x44,
	RK628_MIPI_DCS_GET_SCANLINE		= 0x45,
	RK628_MIPI_DCS_SET_DISPLAY_BRIGHTNESS = 0x51,		/* MIPI DCS 1.3 */
	RK628_MIPI_DCS_GET_DISPLAY_BRIGHTNESS = 0x52,		/* MIPI DCS 1.3 */
	RK628_MIPI_DCS_WRITE_CONTROL_DISPLAY  = 0x53,		/* MIPI DCS 1.3 */
	RK628_MIPI_DCS_GET_CONTROL_DISPLAY	= 0x54,		/* MIPI DCS 1.3 */
	RK628_MIPI_DCS_WRITE_POWER_SAVE	= 0x55,		/* MIPI DCS 1.3 */
	RK628_MIPI_DCS_GET_POWER_SAVE		= 0x56,		/* MIPI DCS 1.3 */
	RK628_MIPI_DCS_SET_CABC_MIN_BRIGHTNESS = 0x5E,	/* MIPI DCS 1.3 */
	RK628_MIPI_DCS_GET_CABC_MIN_BRIGHTNESS = 0x5F,	/* MIPI DCS 1.3 */
	RK628_MIPI_DCS_READ_DDB_START		= 0xA1,
	RK628_MIPI_DCS_READ_DDB_CONTINUE	= 0xA8,
};

/**
 * struct rk628_mipi_dsi_msg - read/write DSI buffer
...
/**
 * struct rk628_mipi_dsi_packet - represents a MIPI DSI packet in protocol format
...
int rk628_dsi_parse(struct rk628 *rk628, ofnode dsi_np)
{
	const char *string;
	int ret;

	if (!ofnode_valid(dsi_np))
		return -EINVAL;
	...
	rk628->dsi0.lanes = ofnode_read_u32_default(dsi_np, "dsi,lanes", 4);
	if (ofnode_read_bool(dsi_np, "dsi,video-mode"))
		rk628->dsi0.mode_flags |= RK628_MIPI_DSI_MODE_LPM | RK628_MIPI_DSI_MODE_VIDEO |
					  RK628_MIPI_DSI_MODE_VIDEO_BURST;
	else
		rk628->dsi0.mode_flags |= RK628_MIPI_DSI_MODE_LPM;

	if (ofnode_read_bool(dsi_np, "dsi,eotp"))
		rk628->dsi0.mode_flags |= RK628_MIPI_DSI_MODE_EOT_PACKET;

	if (ofnode_read_bool(dsi_np, "dsi,clk-non-continuous"))
		rk628->dsi0.mode_flags |= RK628_MIPI_DSI_CLOCK_NON_CONTINUOUS;

	string = ofnode_read_string(dsi_np, "dsi,format");
	if (!strcmp(string, "rgb666")) {
		rk628->dsi0.bus_format = RK628_MIPI_DSI_FMT_RGB666;
		rk628->dsi0.bpp = 24;
	} else if (!strcmp(string, "rgb666-packed")) {
		rk628->dsi0.bus_format = RK628_MIPI_DSI_FMT_RGB666_PACKED;
		rk628->dsi0.bpp = 18;
	} else if (!strcmp(string, "rgb565")) {
		rk628->dsi0.bus_format = RK628_MIPI_DSI_FMT_RGB565;
		rk628->dsi0.bpp = 16;
	} else {
		rk628->dsi0.bus_format = RK628_MIPI_DSI_FMT_RGB888;
		rk628->dsi0.bpp = 24;
	}

	if (ofnode_read_bool(dsi_np, "rockchip,dual-channel")) {
					  ...
					  const struct rk628_dsi *dsi)
{
	...
	ret = rk628_read_poll_timeout(rk628, dsi_base + DSI_CMD_PKT_STATUS,
				      sts, !(sts & GEN_PLD_W_FULL), 0, 1000);
	if (ret < 0) {
		printf("rk628 generic write payload fifo is full\n");
		return ret;
	}
					...
					const struct rk628_dsi *dsi)
{
	...
	ret = rk628_read_poll_timeout(rk628, dsi_base + DSI_CMD_PKT_STATUS,
				      sts, !(sts & GEN_CMD_FULL),
				       0, 1000);
	if (ret < 0) {
		printf("rk628 generic write cmd fifo is full\n");
		return ret;
	}
...
static int genif_wait_write_fifo_empty(struct rk628 *rk628, const struct rk628_dsi *dsi)
{
	...
	ret = rk628_read_poll_timeout(rk628, dsi_base + DSI_CMD_PKT_STATUS,
				      sts, (sts & mask) == mask, 0, 1000);
	if (ret < 0) {
		printf("rk628 generic write fifo is full\n");
		return ret;
	}
...
static int rk628_dsi_read_from_fifo(struct rk628 *rk628,
				    const struct rk628_dsi *dsi,
				    const struct rk628_mipi_dsi_msg *msg)
{
	...
	if (ret) {
		printf("rk628 entire response isn't stored in the FIFO\n");
		return ret;
	}
	...
	for (length = msg->rx_len; length; length -= 4) {
		...
		if (val & GEN_PLD_R_EMPTY)
			ret = -ETIMEDOUT;
		if (ret) {
			printf("rk628 dsi Read payload FIFO is empty\n");
			return ret;
		}
...
/**
 * rk628_mipi_dsi_packet_format_is_short - check if a packet is of the short format
 * @type: MIPI DSI data type of the packet
 *
 * Return: true if the packet for the given data type is a short packet, false
 * otherwise.
 */
static bool rk628_mipi_dsi_packet_format_is_short(u8 type)
{
	switch (type) {
	case RK628_MIPI_DSI_V_SYNC_START:
	case RK628_MIPI_DSI_V_SYNC_END:
	case RK628_MIPI_DSI_H_SYNC_START:
	case RK628_MIPI_DSI_H_SYNC_END:
	case RK628_MIPI_DSI_END_OF_TRANSMISSION:
	case RK628_MIPI_DSI_COLOR_MODE_OFF:
	case RK628_MIPI_DSI_COLOR_MODE_ON:
	case RK628_MIPI_DSI_SHUTDOWN_PERIPHERAL:
	case RK628_MIPI_DSI_TURN_ON_PERIPHERAL:
	case RK628_MIPI_DSI_GENERIC_SHORT_WRITE_0_PARAM:
	case RK628_MIPI_DSI_GENERIC_SHORT_WRITE_1_PARAM:
	case RK628_MIPI_DSI_GENERIC_SHORT_WRITE_2_PARAM:
	case RK628_MIPI_DSI_GENERIC_READ_REQUEST_0_PARAM:
	case RK628_MIPI_DSI_GENERIC_READ_REQUEST_1_PARAM:
	case RK628_MIPI_DSI_GENERIC_READ_REQUEST_2_PARAM:
	case RK628_MIPI_DSI_DCS_SHORT_WRITE:
	case RK628_MIPI_DSI_DCS_SHORT_WRITE_PARAM:
	case RK628_MIPI_DSI_DCS_READ:
	case RK628_MIPI_DSI_DCS_COMPRESSION_MODE:
	case RK628_MIPI_DSI_SET_MAXIMUM_RETURN_PACKET_SIZE:
		return true;
	}
...
/**
 * rk628_mipi_dsi_packet_format_is_long - check if a packet is of the long format
 * @type: MIPI DSI data type of the packet
 *
 * Return: true if the packet for the given data type is a long packet, false
 * otherwise.
 */
static bool rk628_mipi_dsi_packet_format_is_long(u8 type)
{
	switch (type) {
	case RK628_MIPI_DSI_PPS_LONG_WRITE:
	case RK628_MIPI_DSI_NULL_PACKET:
	case RK628_MIPI_DSI_BLANKING_PACKET:
	case RK628_MIPI_DSI_GENERIC_LONG_WRITE:
	case RK628_MIPI_DSI_DCS_LONG_WRITE:
	case RK628_MIPI_DSI_LOOSELY_PACKED_PIXEL_STREAM_YCBCR20:
	case RK628_MIPI_DSI_PACKED_PIXEL_STREAM_YCBCR24:
	case RK628_MIPI_DSI_PACKED_PIXEL_STREAM_YCBCR16:
	case RK628_MIPI_DSI_PACKED_PIXEL_STREAM_30:
	case RK628_MIPI_DSI_PACKED_PIXEL_STREAM_36:
	case RK628_MIPI_DSI_PACKED_PIXEL_STREAM_YCBCR12:
	case RK628_MIPI_DSI_PACKED_PIXEL_STREAM_16:
	case RK628_MIPI_DSI_PACKED_PIXEL_STREAM_18:
	case RK628_MIPI_DSI_PIXEL_STREAM_3BYTE_18:
	case RK628_MIPI_DSI_PACKED_PIXEL_STREAM_24:
		return true;
	}
...
/**
 * rk628_mipi_dsi_create_packet - create a packet from a message according to the
 *     DSI protocol
 ...
 */
static int rk628_mipi_dsi_create_packet(struct rk628_mipi_dsi_packet *packet,
			   const struct rk628_mipi_dsi_msg *msg)
{
	if (!packet || !msg)
		return -EINVAL;
	...
	if (!rk628_mipi_dsi_packet_format_is_short(msg->type) &&
	    !rk628_mipi_dsi_packet_format_is_long(msg->type))
		return -EINVAL;
	 ...
	 * and 2.
	 */
	if (rk628_mipi_dsi_packet_format_is_long(msg->type)) {
...
static int rk628_dsi_transfer(struct rk628 *rk628, const struct rk628_dsi *dsi,
			      const struct rk628_mipi_dsi_msg *msg)
{
	struct rk628_mipi_dsi_packet packet;
	int ret;
	u32 val;

	if (msg->flags & RK628_MIPI_DSI_MSG_REQ_ACK)
		dsi_update_bits(rk628, dsi, DSI_CMD_MODE_CFG,
				ACK_RQST_EN, ACK_RQST_EN);

	if (msg->flags & RK628_MIPI_DSI_MSG_USE_LPM) {
	...
	case RK628_MIPI_DSI_DCS_SHORT_WRITE:
		dsi_update_bits(rk628, dsi, DSI_CMD_MODE_CFG, DCS_SW_0P_TX,
				msg->flags & RK628_MIPI_DSI_MSG_USE_LPM ?
				DCS_SW_0P_TX : 0);
		break;
	case RK628_MIPI_DSI_DCS_SHORT_WRITE_PARAM:
	...
	case RK628_MIPI_DSI_GENERIC_READ_REQUEST_0_PARAM:
		...
		msg->flags & RK628_MIPI_DSI_MSG_USE_LPM ? GEN_SR_0P_TX : 0);
		break;
	case RK628_MIPI_DSI_GENERIC_READ_REQUEST_1_PARAM:
		dsi_update_bits(rk628, dsi, DSI_CMD_MODE_CFG, GEN_SR_1P_TX,
		msg->flags & RK628_MIPI_DSI_MSG_USE_LPM ? GEN_SR_1P_TX : 0);
		break;
	case RK628_MIPI_DSI_GENERIC_READ_REQUEST_2_PARAM:
		dsi_update_bits(rk628, dsi, DSI_CMD_MODE_CFG, GEN_SR_2P_TX,
				msg->flags & RK628_MIPI_DSI_MSG_USE_LPM ? GEN_SR_2P_TX : 0);
		break;
	default:
		return -EINVAL;
	}
	...
	ret = rk628_mipi_dsi_create_packet(&packet, msg);
	if (ret) {
		printf("rk628 dsi failed to create packet\n");
		return ret;
	}
					...
					const void *payload, size_t size)
{
	...
	switch (size) {
	case 0:
		msg.type = RK628_MIPI_DSI_GENERIC_SHORT_WRITE_0_PARAM;
		break;

	case 1:
		msg.type = RK628_MIPI_DSI_GENERIC_SHORT_WRITE_1_PARAM;
		break;
	case 2:
		msg.type = RK628_MIPI_DSI_GENERIC_SHORT_WRITE_2_PARAM;
		break;
	default:
		msg.type = RK628_MIPI_DSI_GENERIC_LONG_WRITE;
		break;
	}

		if (dsi->mode_flags & RK628_MIPI_DSI_MODE_LPM)
			msg.flags |= RK628_MIPI_DSI_MSG_USE_LPM;
					   ...
					   const void *data, size_t len)
{
	...
	case 0:
		return -EINVAL;
	case 1:
		msg.type = RK628_MIPI_DSI_DCS_SHORT_WRITE;
		break;
	case 2:
		msg.type = RK628_MIPI_DSI_DCS_SHORT_WRITE_PARAM;
		break;
	default:
		msg.type = RK628_MIPI_DSI_DCS_LONG_WRITE;
		break;
	}
						  ...
						  void *data, size_t len)
{
	...
	memset(&msg, 0, sizeof(msg));
	msg.channel = dsi->channel;
	msg.type = RK628_MIPI_DSI_DCS_READ;
	msg.tx_buf = &cmd;
	msg.tx_len = 1;
	msg.rx_buf = data;
	msg.rx_len = len;
...
panel_simple_xfer_dsi_cmd_seq(struct rk628 *rk628, struct panel_cmds *cmds)
{
	...
	for (i = 0; i < cmds->cmd_cnt; i++) {
		...
		case RK628_MIPI_DSI_DCS_LONG_WRITE:
			...
			break;
		default:
			printf("rk628 dsi panel cmd desc invalid data type\n");
			return -EINVAL;
		}

		if (err < 0)
			printf("rk628 dsi failed to write cmd\n");
...
{
	const struct drm_display_mode *mode = &dsi->rk628->dst_mode;
	ofnode dsi_np;
	u32 lane_rate, value;
	u32 max_lane_rate = 1500;
	u8 bpp, lanes;

	dsi_np = dev_read_subnode(dsi->rk628->dev, "rk628-dsi-out");
	if (!ofnode_valid(dsi_np))
		dsi_np = dev_read_subnode(dsi->rk628->dev, "rk628-dsi");
	if (ofnode_valid(dsi_np) && !ofnode_read_u32(dsi_np, "rockchip,lane-mbps", &value)) {
		lane_rate = value;
	} else {
		bpp = dsi->bpp;
			 ...
			 u8 reg, u8 value)
{
	...
	printf("rk628 dsi monitor_data: 0x%x\n", monitor_data);
}
...
static void mipi_dphy_power_on(struct rk628 *rk628, const struct rk628_dsi *dsi)
{
	...
	ret = rk628_read_poll_timeout(rk628, dsi_base + DSI_PHY_STATUS,
				      val, val & PHY_LOCK, 0, 1000);
	if (ret < 0)
		printf("rk628 dsi PHY is not locked\n");
	...
	ret = rk628_read_poll_timeout(rk628, dsi_base + DSI_PHY_STATUS,
				      val, (val & mask) == mask,
				       0, 1000);
	if (ret < 0)
		printf("rk628 dsi lane module is not in stop state\n");
					...
					const struct rk628_dsi *dsi)
{
	...
	dsi_write(rk628, dsi, DSI_MODE_CFG, CMD_VIDEO_MODE(RK628_DSI_COMMAND_MODE));
	...
	if (dsi->mode_flags & RK628_MIPI_DSI_MODE_EOT_PACKET)
		val &= ~EOTP_TX_EN;
				   ...
				   const struct drm_display_mode *mode)
{
	...
	if (dsi->mode_flags & RK628_MIPI_DSI_MODE_VIDEO_HFP)
		val &= ~LP_HFP_EN;

	if (dsi->mode_flags & RK628_MIPI_DSI_MODE_VIDEO_HBP)
		val &= ~LP_HBP_EN;

	if (dsi->mode_flags & RK628_MIPI_DSI_MODE_VIDEO_BURST)
		val |= VID_MODE_TYPE_BURST;
	else if (dsi->mode_flags & RK628_MIPI_DSI_MODE_VIDEO_SYNC_PULSE)
	...
	if (dsi->mode_flags & RK628_MIPI_DSI_CLOCK_NON_CONTINUOUS)
		dsi_update_bits(rk628, dsi, DSI_LPCLK_CTRL,
	...
	hline_time = DIV_ROUND_CLOSEST(hline * lanebyteclk, dpipclk);
	...
	dsi_write(rk628, dsi, DSI_MODE_CFG, CMD_VIDEO_MODE(RK628_DSI_VIDEO_MODE));
}
				    ...
				    const struct rk628_dsi *dsi)
{
	...
	if (dsi->mode_flags & RK628_MIPI_DSI_MODE_VIDEO)
...
void rk628_mipi_dsi_pre_enable(struct rk628 *rk628)
{
	...
	rk628_combtxphy_set_mode(rk628, RK628_PHY_MODE_VIDEO_MIPI);
	...
	printf("rk628 dsi: mode: 0x%x\n", mode);
#endif

	printf("rk628_dsi final DSI-Link bandwidth: %d x %d\n",
...
void rk628_dsi_disable(struct rk628 *rk628)
{
	...
	if (dsi->slave) {
		...
		dsi_write(rk628, dsi1, DSI_MODE_CFG,
			  CMD_VIDEO_MODE(RK628_DSI_COMMAND_MODE));
