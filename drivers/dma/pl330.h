...
#define DMAC_MODE_NS	(1 << 0)
	uint32	mode;
	uint32	data_bus_width:10; /* In number of bits */
	uint32	data_buf_dep:10;
	uint32	num_chan:4;
	uint32	num_peri:6;
	uint32		peri_ns;
	uint32	num_events:6;
...
struct pl330_reqcfg {
	...
	uint32 brst_len:5;
	/*
	 * 0:write 1 byte per beat
	 * 1:write 2 byte per beat
	 * 2:write 4 byte per beat
	 * 3:write 8 byte per beat
	 * 4:write 16 byte per beat
	 */
	uint32 brst_size:3; /* in power of 2 */
