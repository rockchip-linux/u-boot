...
int pmic_charger_setting(int current)
{
    ...
    i2c_reg_write(CONFIG_SYS_I2C_SLAVE,0xb8,0x90);	 /* ICHG	1700ma,	= 0x0-0x1D (100mA - 3000mA) */
    ...
    {
        i2c_reg_write(CONFIG_SYS_I2C_SLAVE,0xb3, i2c_reg_read(CONFIG_SYS_I2C_SLAVE,0xb3)|0x03);      //enable charging 
        i2c_reg_write(CONFIG_SYS_I2C_SLAVE,0xb6,0x11);	/* ILIM_ADP	0x11= 0x0-0x1D (100mA - 3000mA) */
        i2c_reg_write(CONFIG_SYS_I2C_SLAVE,0xb7,(i2c_reg_read(CONFIG_SYS_I2C_SLAVE,0xb7)&0xe0)|0x11);/* ILIM_USB 0x07,= 0x0-0x1D (100mA - 3000mA) */
    }
    return 0;
}
