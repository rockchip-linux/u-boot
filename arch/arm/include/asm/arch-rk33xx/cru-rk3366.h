 ...
 */
#ifndef __RK3366_CRU_H
#define __RK3366_CRU_H
...
#define PLL_DACPD_SHIFT		3
#define PLL_DACPD_MSK		(1 << 3)
#define PLL_DACPD_W_MSK		(PLL_DACPD_MSK << 16)
#define PLL_DACPD		(1 << 3)
#define PLL_NO_DACPD		(0 << 3)

#define PLL_DSMPD_SHIFT		2
#define PLL_DSMPD_MSK		(1 << 2)
#define PLL_DSMPD_W_MSK		(PLL_DSMPD_MSK << 16)
#define PLL_DSMPD		(1 << 2)
#define PLL_NO_DSMPD		(0 << 2)
...
/*******************CLKSEL0 BITS***************************/
/* a53 core axi clock div: clk = clk_src / (div_con + 1) */
#define CORE_AXI_CLK_DIV_OFF 		8
#define CORE_AXI_CLK_DIV_W_MSK		(0xF << (8 + 16))
#define CORE_AXI_CLK_DIV_MSK		(0xF << 8)
#define CORE_AXI_CLK_DIV(i)		((((i) - 1) & 0xF) << 8)

/* a53 core clk pll sel: arm or general or ddr */
...
/* a53 core debug pclk clock div: clk = clk_src / (div_con + 1) */
...
/* a53 core ATB div: clk = clk_src / (div_con + 1) */
...
#define PDBUS_HCLK_DIV(i)		((((i) - 1) & 0x3) << 8)
