...
enum {
	...
	/* CRU_CLKSEL_CON20 */
	CLK_HDMITX_EARC_HIGH_SRC_DIV_SHIFT	= 12,
	CLK_HDMITX_EARC_HIGH_SRC_DIV_MASK	= 0x7 << CLK_HDMITX_EARC_HIGH_SRC_DIV_SHIFT,
	ACLK_VO_ROOT_SEL_SHIFT		= 11,
	ACLK_VO_ROOT_SEL_MASK		= 1 << ACLK_VO_ROOT_SEL_SHIFT,
	ACLK_VO_ROOT_SEL_GPLL		= 0U,
	ACLK_VO_ROOT_SEL_CPLL,
	ACLK_VO_ROOT_DIV_SHIFT		= 6,
	...
	/* VOCRU_CLKSEL_CON1 */
	CLK_IREFCLK_HDMITX_SEL_SHIFT	= 14,
	CLK_IREFCLK_HDMITX_SEL_MASK	= 0x1 << CLK_IREFCLK_HDMITX_SEL_SHIFT,
	CLK_IREFCLK_HDMITX_SEL_ACLK	= 0U,
	CLK_IREFCLK_HDMITX_SEL_HIGH,
	CLK_HDMITX_EARC_HIGH_FOR_IREFCLK_DIV_SHIFT	= 12,
	CLK_HDMITX_EARC_HIGH_FOR_IREFCLK_DIV_MASK	= 0x3 << CLK_HDMITX_EARC_HIGH_FOR_IREFCLK_DIV_SHIFT,
