...
#define GRF_DDR3_EN           			((0x1<<6)<<16) | (0x1<<6) /*for noc*/
...
/* GRF_OS_REG2 */
enum {
	DDR_CHB_ROW_3_4_MASK	= 1,
	DDR_CHB_ROW_3_4_SHIFT	= 31,
	DDR_CHA_ROW_3_4_MASK	= 1,
	DDR_CHA_ROW_3_4_SHIFT	= 30,
	/*
	 * 000: lpddr
	 * 001: ddr
	 * 010: ddr2
