...
#define PLL_CONS(id, i)		((id) * 0x0C + ((i) * 4))

#define CRU_CLKSELS_CON_CNT	(35)
#define CRU_CLKSELS_CON(i)	(CRU_CLKSEL_CON + ((i) * 4))

#define CRU_CLKGATES_CON_CNT	(16)
...
#define CRU_GLB_SRST_FST	0x1F0
#define CRU_GLB_SRST_SND	0x1F4

#define CRU_PLL_MASK_CON	0x1F8
...
/* core clk pll sel: arm or general or ddr */
#define CORE_SEL_PLL_OFF		7
#define CORE_SEL_PLL_W_MSK		(3 << (7 + 16))
#define CORE_SEL_PLL_MSK		(3 << 7)
#define CORE_SEL_APLL			(0 << 7)
#define CORE_SEL_GPLL			(1 << 7)
#define CORE_SEL_DPLL			(2 << 7)
...
/* core peri div: clk = clk_src / (div_con + 1) */
#define CORE_PERI_DIV_OFF		0
#define CORE_PERI_DIV_W_MSK		(0xF << (0 + 16))
#define CORE_PERI_DIV_MSK		(0xF << 0)
#define CORE_PERI_DIV(i)		((((i) - 1) & 0xF) << 0)
...
/* peripheral bus clk pll sel: codec or general or hdmiphy */
#define PERI_SEL_PLL_OFF		10
#define PERI_SEL_PLL_W_MSK		(3 << (10 + 16))
#define PERI_SEL_PLL_MSK		(3 << 10)
#define PERI_SEL_CPLL			(0 << 10)
#define PERI_SEL_GPLL			(1 << 10)
#define PERI_SEL_HDMIPHYPLL		(2 << 10)
