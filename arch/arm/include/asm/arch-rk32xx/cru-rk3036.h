...
#define CRU_SDMMC_CON0		(0x144)
#define CRU_SDMMC_CON1		(0x148)
#define CRU_SDIO_CON0		(0x14C)
#define CRU_SDIO_CON1		(0x150)
#define CRU_EMMC_CON0		(0x154)
#define CRU_EMMC_CON1		(0x158)
#define CRU_GLB_RST_ST		(0x160)
...
/*******************CLKSEL0 BITS***************************/
/* cpu clock sel: arm or ddr or general */
#define CPU_SEL_PLL_OFF 		14
#define CPU_SEL_PLL_W_MSK		(0x3 << (14 + 16))
#define CPU_SEL_PLL_MSK			(0x3 << 14)
#define CPU_SEL_APLL			(0 << 14)
#define CPU_SEL_DPLL			(1 << 14)
#define CPU_SEL_GPLL			(2 << 14)
...
#define PERI_SEL_APLL			(0 << 14)
#define PERI_SEL_DPLL			(1 << 14)
#define PERI_SEL_GPLL			(2 << 14)
