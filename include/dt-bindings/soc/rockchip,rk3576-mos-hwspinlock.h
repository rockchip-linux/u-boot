...
/*
 * Header providing constants for Rockchip RK3576 MOS hwspinlock.
 *
 * Copyright (C) 2025, Rockchip Electronics Co., Ltd.
 */

#ifndef __DT_BINDINGS_RK3576_MOS_HWSPINLOCK_H__
#define __DT_BINDINGS_RK3576_MOS_HWSPINLOCK_H__
